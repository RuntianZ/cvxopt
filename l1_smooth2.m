function [x1, out1] = l1_smooth2(x0, A, b, mu, opts1)
%l1_smooth2 - Gradient method for smoothed primal
% opts1: [lambda k]
% lambda - Parameter of smoothing (default = 10)
% k      - Number of iterations (default = 1000)
% Step size rule: BB
% Smoother: l*log((exp(x/l)+exp(-x/l))/2)
n = size(A);
m = n(1);
n = n(2);
...
for i = 1:k
    g2 = g1;
    g1 = x1/lambda;
    g1 = (exp(g1)-exp(-g1))./(exp(g1)+exp(-g1));
    g1 = g1+A'*(A*x1-b);
    if i == 1
        t = 0.0005;
    else
